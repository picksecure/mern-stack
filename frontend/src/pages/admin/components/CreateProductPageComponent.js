              ...
              <Form.Control name="price" required type="text" />
                        ...
                        <Form.Group className="mb-3" controlId="formBasicBarcode">
                          ...
                          <Form.Label>Barcode</Form.Label>
                                    <Form.Control aria-describedby="button-addon2" value={barcode} onChange={(e) => setBarcode(e.target.value)} name="barcode" required type="number" />
                                </Col>
                                <Col className="mt-4 pt-2">
                                    <Button variant="outline-primary" onClick={randomBar} id="button-addon2">
                                        Generate
                                    </Button>
                                </Col>
                            </Row>
                            ...
                            <Form.Group className="mb-3" controlId="formBasicFeatured">
                                ...
                                <Form.Select name="featured" aria-label="Default select example">
